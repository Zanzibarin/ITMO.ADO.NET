...
namespace ADO.NET.LAB4._2
{
    public partial class CreatingDataTable : Form
    {
        ...
        private void MakeParentTable()
        {
            ...
            //Добавление первой колонки в таблицу
            ...
            //Определение колонки Id в качестве первичного ключа
            DataColumn[] PrimaryKeyColumns = new DataColumn[1];
            PrimaryKeyColumns[0] = table.Columns["id"];
            table.PrimaryKey = PrimaryKeyColumns;

            //Добавление второй колонки в таблицу
            column = new DataColumn();
            ...
            //Добавление третье и четвёртой колонок в таблицу с помощью метода Add
        ...
        private void ChildTbleFillBtn_Click(object sender, EventArgs e)
        {
            dataGridView2.DataSource = bindingSource2;
        }

        private void ParentTbleFillBtn_Click(object sender, EventArgs e)
        {
