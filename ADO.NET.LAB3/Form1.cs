...
namespace ADO.NET.LAB3
{
    public partial class DBCommand : Form
    {
        ...
        //Кнопка Пакетный запрос
        private void button2_Click(object sender, EventArgs e)
        {
            StringBuilder results = new StringBuilder();
            using (sqlConnection1)
            {
                sqlCommand1.CommandText = "SELECT CustomerID, " +
                    "CompanyName FROM Customers; " + "SELECT ProductName, " +
                    "UnitPrice, QuantityPerUnit FROM Products; ";
